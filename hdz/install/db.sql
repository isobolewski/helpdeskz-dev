...
('account_activation', 7, 'Account activation email', 'Account activation', '<p>Hello %client_name%,</p><br/><p>Please click on the link to activate your account.</p><p><a href="%support_url%account-activation/%activation_link%">Activate here</a></p>', 0, 1);
